...
<body>
    ...
    <div class="description-container">
        ...
        <div class="text">
                <p>School project in team of 3</p>
                <p>Designer</p>
                <p>2019</p>
                <p>Sketch</p>
            </div>
    ...
    <div class="project">
        <div class="project-title">
            <div class="h2-container">
                <h2 class="h2-title">The wireless earbuds</h2>
    ...
    <div class="content-description">
        <div class="container-text">
            <h2>Start broad to get to the essentials  </h2>
            <p>During this project, we had to think about highlighting the right information to arouse the user's interest, that's why we find for example a faq under a product page. </p>
        </div>
    </div>
    ...
    <div class="content-description-2">
            <div class="container-text">
                <h2 class="color-white">When design meet technology</h2>
            </div>
    </div>
    <div class="project">
        <div class="project-background">
